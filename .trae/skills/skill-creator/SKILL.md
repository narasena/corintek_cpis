...
description: "A skill for Tailwind"  # âŒ 25 chars

# Too long (wastes tokens):
description: "This comprehensive skill provides detailed knowledge..."  # âŒ 500+ chars
...
```yaml
# âŒ Bad: Passive, vague, no discovery keywords
description: |
...
# âœ… Good: Active, specific, discoverable
description: |
...
â””â”€â”€ README.md         # Auto-trigger keywords (required)
```
...
```
skills/my-skill/
â”œâ”€â”€ scripts/          # Executable helpers
â”‚   â””â”€â”€ setup.sh      # Example: automated setup script
â”œâ”€â”€ references/       # Extended documentation
â”‚   â””â”€â”€ api-guide.md  # Loaded when user needs deep details
â””â”€â”€ assets/           # Templates, images
    â””â”€â”€ config.json   # Template files for output
```
...
```yaml
# âŒ Claude already knows JavaScript basics
## Variables
Use `const` for constants and `let` for variables...

# âœ… Focus on what Claude might get wrong
...
```markdown
# âŒ Too rigid (breaks if API changes)
Always call api.configure({ version: "2.1.0" }) first.

# âœ… Flexible with rationale

    ...
    <div className="flex flex-1 flex-col gap-4 p-4 md:p-6">
      <div className="grid auto-rows-min gap-4 md:grid-cols-3">
        <div className="aspect-video rounded-xl bg-muted/50 flex flex-col items-center justify-center p-6 text-center">
          ...
          <span className="text-sm text-muted-foreground mt-1">Project Information System</span>
        </div>
        <div className="aspect-video rounded-xl bg-muted/50 flex flex-col items-center justify-center p-6 text-center">
          <span className="text-sm text-muted-foreground uppercase tracking-wider">Role Anda</span>
        ...
        <div className="aspect-video rounded-xl bg-muted/50 flex flex-col items-center justify-center p-6 text-center">
          ...
          <span className="text-xl font-semibold mt-1 text-green-600">Online</span>
        </div>
      </div>
      <div className="min-h-[60vh] flex-1 rounded-xl bg-muted/50 p-8">
        <div className="max-w-2xl">
          <h1 className="text-3xl font-bold mb-4">Selamat Datang di Corintek CPIS</h1>
          <p className="text-lg text-muted-foreground mb-8">
            Kelola proyek, klien, dan laporan Anda dengan mudah melalui sistem informasi terintegrasi ini.
          </p>

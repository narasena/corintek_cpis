...
import { getWorkReportProjectColumns } from './components/project-columns';
...
export default function WorkReportsPage() {
  ...
  const columns = useMemo(() => getWorkReportProjectColumns(), []);

  return (
    <div className="space-y-4 md:space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Work Report</h1>
        <p className="text-muted-foreground mt-2">
          Pilih proyek untuk mengelola work report.
        </p>
      </div>

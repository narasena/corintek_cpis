...
describe('validateLogSheetApprovalDetail (characterization)', () => {
  describe('range validation', () => {
    it('passes when all required values are complete', () => {
    ...
    it('fails when value is above maximum', () => {
      const detail = createBaseDetail({
        entries: [
          {
            id: 'e-1',
    ...
    it('uses RAW_WATER limits for RAW_WATER role entries', () => {
      const detail = createBaseDetail({
        entries: [
          {
            id: 'e-1',
    ...
    it('accepts value exactly at minimum boundary', () => {
      const detail = createBaseDetail({
        entries: [
          {
            id: 'e-1',
    ...
    it('accepts value exactly at maximum boundary', () => {
      const detail = createBaseDetail({
        entries: [
          {
            id: 'e-1',
    ...
    it('skips range validation when parameter not found (SURPRISING: silent skip)', () => {
      const detail = createBaseDetail({
        entries: [
          {
            id: 'e-1',

...
| ---------------------------- | -----: | ----: | -----: |
| Total Lines of Code (ts/tsx) |  7,232 | 7,303 |    +71 |
| Code Files (.ts/.tsx)        |     59 |    60 |    +1 |
| Largest File (LOC)           |    726 |   726 |      0 |
| Files >300 lines             |      5 |     5 |      0 |
| Methods >50 lines            |      6 |     6 |      0 |
| TODO/FIXME/HACK Comments     |      0 |     0 |      0 |
| Est. Cyclomatic Complexity   | High   | High  |      — |
| Tests Passing                |    N/A |    79 |      — |
...
| 5   | src/components/multi-select.tsx               |   163 | **Refactored**: Extracted sub-components   |
...
| 11  | src/lib/jwt.ts                                |    96 | **Refactored**: Discriminated Error codes  |
